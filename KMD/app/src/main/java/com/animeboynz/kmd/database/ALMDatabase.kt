...
@Database(entities = [EmployeeEntity::class, ProductsEntity::class, CustomerOrderEntity::class, OrderItemEntity::class, BarcodesEntity::class, ColorsEntity::class], version = 1)
